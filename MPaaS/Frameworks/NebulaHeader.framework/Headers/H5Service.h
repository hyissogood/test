 ...
 *  @param JSApis   JSAPI接口字典
 */
- (UIWebView *)createWebViewWithParams:(NSDictionary *)params JSApis:(NSDictionary *)JSApis DEPRECATED_ATTRIBUTE; // 废弃方法，请使用下面方法


- (UIWebView *)createWebViewWithVC:(UIViewController *)currentVC params:(NSDictionary *)params JSApis:(NSDictionary *)JSApis;
 ...
 *  @param JSApis   JSAPI接口字典
 */
+ (UIWebView *)createWebViewWithParams:(NSDictionary *)params JSApis:(NSDictionary *)JSApis DEPRECATED_ATTRIBUTE;
...
/**
 *    subView模式下会回调ContentSize的变化
 *    @param     size     当前WebView的Size
 */
//- (void)webView:(UIWebView *)webView didChangeContentSize:(CGSize)size;
@end
